...
const galleryItems = [
  ...
  },
  {
    ...
    prompt: "Robot mascot — low-resolution draft (Seed 123)",
    image: "/assets/experiments/mesh_quality/mesh_res_128/seed_123.png",
    glb: "/assets/experiments/mesh_quality/mesh_res_128/seed_123.glb",
    params: { seed: 123, guidance: 7.5, steps: 30, meshRes: 128 },
  ...
  },
  {
    ...
    prompt: "Robot mascot — standard quality (Seed 999)",
    image: "/assets/experiments/mesh_quality/mesh_res_256/seed_999.png",
    glb: "/assets/experiments/mesh_quality/mesh_res_256/seed_999.glb",
    params: { seed: 999, guidance: 7.5, steps: 30, meshRes: 256 },
